...
%   nonsparse.
%   nlb: widm of the cluster to be eroded.
...
%   Chunli Dai, April 2018, chunlidai1@gmail.com
    ...
    %get rid of a long thin (100 m widm) beach band
    Mextra=BW;
    Me1=imerode(Mextra, ones(nlb));   
%   Md1 = imdilate(Me1, ones(widm2/resr));
    ...
    for k=1:CC.NumObjects
        ...
        if ~isempty(idt)
            ...
            %check if this cluster is a long thin (100 m widm) beach band 
            BW3=BW;BW3(:)=0;
